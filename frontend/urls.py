...
urlpatterns = [
    ...
    path('staff/my-articles/', views.staff_my_articles, name='staff_my_articles'),
    ...
    path('api/articles/reporter/articles/', views.portal_reporter_articles, name='api_portal_reporter_articles'),
